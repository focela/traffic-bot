...
MAX_CONCURRENT_BOTS = 10  # Maximum number of bots to run concurrently
MIN_DELAY = 60  # Minimum delay between bot runs (seconds)
MAX_DELAY = 300  # Maximum delay between bot runs (seconds)
